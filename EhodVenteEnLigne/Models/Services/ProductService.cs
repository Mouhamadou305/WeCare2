...
namespace EhodBoutiqueEnLigne.Models.Services
{
    public class ProductService : IProductService
    {
        ...
        public List<ProductViewModel> GetAllProductsViewModel()
        {
            ...
            IEnumerable<MedicalFile> productEntities = GetAllProducts();
            return MapToViewModel(productEntities);
        }

        private static List<ProductViewModel> MapToViewModel(IEnumerable<MedicalFile> productEntities)
        {
            List <ProductViewModel> products = new List<ProductViewModel>();
            foreach (MedicalFile product in productEntities)
            {
        ...
        public List<MedicalFile> GetAllProducts()
        {
            IEnumerable<MedicalFile> productEntities = _productRepository.GetAllProducts();
        ...
        public MedicalFile GetProductById(int id)
        {
            List<MedicalFile> products = GetAllProducts().ToList();
            return products.Find(p => p.Id == id);
        }
        ...
        private static MedicalFile MapToProductEntity(ProductViewModel product)
        {
            MedicalFile productEntity = new MedicalFile
            {
                Name = product.Name,
