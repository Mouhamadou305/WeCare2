...
namespace EhodBoutiqueEnLigne.Tests
{
    public class OrderServiceTests
    {
        ...
        public void SaveOrder_ShouldSaveOrder()
        {
            ...
            {
                new CartLine { Product = new MedicalFile { Id = 1, Name = "Product 1" }, Quantity = 20 },
                new CartLine { Product = new MedicalFile { Id = 2, Name = "Product 2" }, Quantity = 10 }
            };
        ...
        public void SaveOrder_ShouldThrowException()
        {
            ...
            // Act & Assert
            Assert.Throws<System.NullReferenceException>(() => _orderService.SaveOrder(_ordersViewModel[0]));
        }
    }
}