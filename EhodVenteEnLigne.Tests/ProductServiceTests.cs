...
namespace EhodBoutiqueEnLigne.Tests
{
    ...
    {
        private readonly MedicalFile[] _products;
        ...
        {
            _products = new MedicalFile[]
            {
                new MedicalFile { Id = 1, Name = "Product 1" },
                new MedicalFile { Id = 2, Name = "Product 2" }
            };
        ...
        {
            // Arrange
            _context.Setup(x => x.GetAllProducts()).Returns(new List<MedicalFile>());
        ...
        public void GetProductById_ShouldReturnProduct1()
        {
            ...
            _context.Setup(x => x.GetProduct(1)).ReturnsAsync(new MedicalFile { Id = 1, Name = "Product 1" });

            _productService = new ProductService(null, _context.Object);

            // Act
            MedicalFile product = _productService.GetProductById(1);
        ...
        public void SaveProduct_ShouldSaveProduct()
        {
            ...
            _context.Setup(x => x.SaveProduct(It.IsAny<MedicalFile>()));
            _productService = new ProductService(_cart, _context.Object);
            ...
            // Assert
            _context.Verify(x => x.SaveProduct(It.IsAny<MedicalFile>()), Times.Once);
        }
